...
export const metadata: Metadata = createPageMetadata({
  title: "Contact Phoenix Chimney & Fireplace Services | Calgary Booking",
  description:
    "Call, book online, or send a service request for fireplace repair, chimney work, and WETT inspections in Calgary and nearby communities.",
  path: "/contact",
          ...
          <div className="grid gap-0 lg:grid-cols-[0.75fr_1.25fr]">
            <div className="space-y-5 p-8">
              ...
              <h2 className="text-balance text-3xl font-semibold tracking-tight text-[var(--color-ink)] sm:text-4xl">
                Calgary-focused, with surrounding communities covered as needed.
              </h2>
              <p className="text-sm leading-8 text-[var(--color-muted)] sm:text-base">
                If you are unsure whether your area is covered, call first. The current service radius includes Calgary plus nearby communities within roughly 100 kilometres.
              </p>
