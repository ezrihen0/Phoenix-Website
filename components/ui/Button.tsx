...
export function Button({ href, children, variant = "primary", external = false }: ButtonProps) {
  const className = variant === "primary" ? "rounded-full bg-[var(--button-primary-bg)] px-6 py-3 text-[var(--button-primary-text)] premium-glow" : "rounded-full border border-[rgba(255,255,255,0.35)] px-6 py-3 text-[var(--button-secondary-text)]";
