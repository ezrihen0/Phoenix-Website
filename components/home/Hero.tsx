...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-[var(--surface-hero)] py-20 text-[var(--hero-title)]">
      ...
      <div className="container-shell relative grid items-center gap-10 md:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-lg text-[var(--hero-subtitle)]">Gas fireplace repair, WETT inspections, chimney sweeping, and chimney repairs for homeowners in Calgary, Edmonton, Red Deer, and surrounding areas.</p>
